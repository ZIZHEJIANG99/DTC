...
document.querySelectorAll('.collection-tab').forEach((tab) => {
  var colHandle = tab.getAttribute('data-handle');

  tab.addEventListener('click', (event) => {
    document.querySelectorAll('.home-collection-tab').forEach((cl) => {
      cl.classList.add('hidden');
    });
    document.querySelectorAll('.collection-tab').forEach((hd) => {
      hd.classList.remove('active');
    });
    tab.classList.add('active');
    //document.querySelectorAll(".tab-collection-"+colHandle).classList.remove('hidden');
    document.querySelectorAll(".tab-collection-"+colHandle).forEach((sh) => {
